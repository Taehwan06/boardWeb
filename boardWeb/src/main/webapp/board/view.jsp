...
<script>	
	function replyInsert(){
		$.ajax({
			...
			success: function(data){
					...
					var html = "";
					html += "<tr>";
					html += "<td>"+json[0].writer+" :<input type='hidden' "
							+"name='ridx' value='json[0].ridx'></td>";
					html += "<td>"+json[0].rcontent+"</td>";					
					html += "<td><button onclick='replyModify("+json[0].ridx+",this)'>수정</button>"							
							+"<button onclick='deletFn("+json[0].ridx+",this)'>삭제</button></td>";
					html += "</tr>";
	...
	function modify(obj){
		...
		var html = "";
		html = "<input type='text' name='rcontent'"
				+" value='"+rcontent+"' size='50'>";
		$(obj).parent().prev().html(html);
		
		html = "<input type='button' value='저장' onclick='updateReply(this)'>"
	...
	function updateReply(obj){
		...
		$.ajax({
			...
			success: function(data){
				...
				var html = "<input type='button' value='수정' onclick='replyModify(this)'>";
				html += "<input type='button' value='삭제' onclick='deletFn(this)'>";
				$(obj).parent().html(html);
			}			
		});
	}
